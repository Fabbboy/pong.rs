...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke0_mut__hc07ae0ebf0de7cab: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h115b61f9961c5060: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__hfa5656979f4a382b: (a: number, b: number, c: number, d: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h2d55e412adba4170: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__hac6acff75ad6362e: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h397ca9a6478de1e1: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h67a442bd27895649: (a: number, b: number, c: number) => void;
